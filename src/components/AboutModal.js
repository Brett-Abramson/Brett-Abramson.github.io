      ...
      >
        <div className="flex w-full flex-col justify-center rounded border-x border-y border-solid border-zinc-50 bg-zinc-800 text-slate-50 sm:m-auto sm:max-w-xs md:max-w-lg lg:max-w-3xl">
          <div className="mx-5">
            ...
            <p className="mx-4 pb-4 indent-4 text-sm">
            ...
            <details>
              ...
              <p className="mx-4 pb-4 text-sm">
                ...
                coding reignited. After several years of self-study and
                consulting with friends already working as developers, I made
                the decision to take the plunge and enroll in a coding boot
                camp.
                <br />
                <br />
            ...
            <div>
              ...
              <ul className="my-4 lg:my-8 flex justify-between lg:justify-around">
