  ...
  return (
    <>
      <div className="flex h-full flex-col  md:justify-between">
        ...
        <button className="w-fit rounded bg-gradient-to-r from-indigo-900 via-indigo-700 to-indigo-500 px-4 py-2  font-semibold text-slate-50 hover:scale-110 md:text-base xl:text-xl">
          About Me
        </button>
      </div>
    </>
